      ...
      <div className="flex items-center gap-3 mx-auto sm:mx-0">
        ...
        <button
          ...
          className={`p-3.5 rounded-2xl transition-all cursor-pointer border ${
            audioEnabled
              ? "bg-slate-100 hover:bg-slate-200 text-slaate-800 text-slate-800 border-slate-300 shadow-xs"
        ...
        <button
          ...
          title="Toggle Pariticipants List"
        >
