...
const Sessions = () => {
  ...
  const [selectedSession, setSelctedSession] = useState(null);
    ...
    <main className="flex-1 max-w-7xl w-full mx-auto p-6 md:p-12">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-slate-500 mt-1">
          Review your past and active meeting history, pariticipant logs, and
          chat transcripts.
        </p>
      </div>
      ...
      <SessionDetailModal
        ...
        onClose={() => setSelctedSession(null)}
      />
    </main>
  );
};
